    ...
    <form action="${pageContext.request.contextPath}/modifyBasic" method="post">
        ...
        <div class="buttons">
            <c:choose>
			    ...
			    <c:otherwise>
			        <button type="submit" class="btn btn-secondary" id="submitBtn">기안</button>
			    </c:otherwise>
			</c:choose>
        </div>
    </form>
           ...
           <div class="modal-content">
             ...
             <!-- 모달 푸터 -->
               <div class="modal-footer">
            		<button type="button" class="btn btn-secondary" onclick="closeMiddleApproverModal()">닫기</button>
   ...
   <div class="modal" id="finalApproverModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel" style="display: none;">
       <div class="modal-dialog">
           <div class="modal-content">
              ...
              <!-- 모달 푸터 -->
               <div class="modal-footer">
            		<button type="button" class="btn btn-light" onclick="closeFinalApproverModal()">닫기</button>
   ...
   <div class="modal" id="recipientsModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel" style="display: none;">
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <!-- 모달 푸터 -->
           	<div class="modal-footer">
            	<button type="button" class="btn btn-light" onclick="closeModal('recipients')">닫기</button>
