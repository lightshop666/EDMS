    ...
    <script type='text/javascript'>
        $(document).ready(function(){
            $(".draftDeleteBtn").click(function(){
                ...
                $.ajax({
                    url : "${pageContext.request.contextPath}/draft/receiveDraft",
                    method : "POST",
...
<div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
   ...
   <br>
    <h2 class="draftCategory">수신함</h2> <br>
    
    <!-- 검색 조건 영역 -->
    <form method="get" action="${pageContext.request.contextPath}/draft/receiveDraft">
		...
		<div class="search-area" style="display: flex; align-items: center;">
	        ...
	        <a href="${pageContext.request.contextPath}/draft/receiveDraft" class="btn waves-effect waves-light btn-outline-dark">초기화</a>
	    </div> <br>
    </form>
    
    <!-- 문서 제출 목록 출력 -->
    <form method="post" action="${pageContext.request.contextPath}/draft/receiveDraft">
    ...
    <nav aria-label="Page navigation example" style="text-align: center;">
    	<ul class="pagination justify-content-center">
		    <c:if test="${minPage > 1 }">
		    	<li class="page-item">
		        	<a class="page-link" aria-label="Previous" href="${pageContext.request.contextPath}/draft/receiveDraft?currentPage=${currentPage - 1}&startDate=${startDate}&endDate=${endDate}&searchCol=${searchCol}&searchWord=${searchWord}&col=${col}&ascDesc=${ascDesc}">
    		...
    		<li class="page-item">
        		...
        		<c:if test="${i != currentPage}">
            		<a class="page-link" href="${pageContext.request.contextPath}/draft/receiveDraft?currentPage=${i}&startDate=${startDate}&endDate=${endDate}&searchCol=${searchCol}&searchWord=${searchWord}&col=${col}&ascDesc=${ascDesc}">${i}</a>
       			</c:if>
       		</li>
    		</c:forEach>
    		...
    		<c:if test="${lastPage > currentPage}">
    			<li class="page-item">
			        <a class="page-link" aria-label="Next" href="${pageContext.request.contextPath}/draft/receiveDraft?currentPage=${currentPage + 1}&startDate=${startDate}&endDate=${endDate}&searchCol=${searchCol}&searchWord=${searchWord}&col=${col}&ascDesc=${ascDesc}">
			        	<span aria-hidden="true">&gt;</span>
