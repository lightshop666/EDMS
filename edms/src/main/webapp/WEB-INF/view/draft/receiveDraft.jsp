    ...
    <script type='text/javascript'>
        $(document).ready(function(){
            $(".draftDeleteBtn").click(function(){
                ...
                $.ajax({
                    url : "${pageContext.request.contextPath}/receiveDraft",
                    method : "POST",
...
<body>
    ...
    <!-- 검색 조건 영역 -->
    <form method="get" action="${pageContext.request.contextPath}/receiveDraft">
        <div class="date-area">
    ...
    <!-- 문서 제출 목록 출력 -->
    <form method="post" action="${pageContext.request.contextPath}/receiveDraft">
        <table border="1">
            <tr>
                <th>양식</th>
                <th>기안자</th>
