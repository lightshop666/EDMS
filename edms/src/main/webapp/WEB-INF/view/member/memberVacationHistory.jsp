...
<body>
    ...
    <form method="GET" action="/goodeeFit/member/memberVacationHistory">
    ...
    <div>
        <a href="/goodeeFit/member/memberVacationHistory?vacationName=연차">연차</a>
        <a href="/goodeeFit/member/memberVacationHistory?vacationName=보상">보상</a>
    </div>
        ...
        <ul class="pagination">
            <c:forEach var="page" begin="${minPage}" end="${maxPage}">
                <li class="page-item ${currentPage eq page ? 'active' : ''}">
                    <a class="page-link" href="/goodeeFit/member/memberVacationHistory?currentPage=${page}&startDate=${startDate}&endDate=${endDate}&vacationName=${vacationName}&col=${col}&ascDesc=${ascDesc}">
                        ${page}
                    </a>
                </li>
            </c:forEach>
